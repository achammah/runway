...
const OFFER_PROMPT := """You price a new product or service for a startup-survival game. You receive the company (what kind, for whom, the idea) and the founder's plain-words description of something new they want to sell. Output realistic market terms as strict JSON:
- name: a short clean name for the offer (from the founder's words, <=40 chars)
...
- unit_cost: the marginal cost to serve ONE unit (materials, compute, labor share — typically 15-60% of fair_price)
- elasticity: 0.8 for luxury/inelastic, ~2.0 typical, 2.6 for commodity
